...
const BackParallax = ({
  ...
  const translateXplus =
    sun > 10 ? 'translate-x-[0px]' : ' translate-x-[1000px] '
  const translateXless =
    sun > 10 ? 'translate-x-[0px]' : ' translate-x-[-1000px] '
  ...
  return (
    ...
    >
      ...
      <div
        className={
          'absolute transition-transform top-0 duration-[1s]  ease-linear z-10  bg-[url("/ligth.png")]  bg-cover flex justify-center  items-start	p-5  h-full w-full left-0' +
          ` ${sunMotion[sun]}`
        }
      >
        <LeftCloud
          className={
            'duration-[1.5s] z-[31]  delay-75 ease-in transition-all ' +
            translateXless
          }
          width="300px "
        />
        ...
        <RightCloud
          className={
            'duration-[1.5s]  z-30 ease-linear transition-all ' + translateXplus
          }
          width="300px "
        />
      </div>
