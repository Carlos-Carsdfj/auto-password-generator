...
export default function App() {
  ...
  const opacity = format[FORMAT_OPTIONS.UPPER_CASE] ? 0 : 30
    ...
    >
      ...
      >
        <div className=" w-full sm:w-4/12 p-6 bg-transparent relative  rounded-sm text-center border-surf border ">
          <div
            className={'absolute w-full h-full bg-surf  top-0 left-0 ' + boxBg}
          ></div>
          <button
          ...
          <form className="relative z-50">
            ...
            <h1 className="font-special font-bold text-lg  mb-2">
              {' '}
